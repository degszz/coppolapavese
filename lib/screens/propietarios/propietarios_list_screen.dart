    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error al cargar propietarios: $e')),
        );
      }
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _infoMonto(
                      label: 'Pendiente',
                      monto: fmt.format(totalPendiente),
              ...
              Row(
                ...
                children: [
                  TextButton.icon(
                    onPressed: () => _irAFormularioEditar(datos),
                  ...
                  ElevatedButton.icon(
                    onPressed: () => _verDetalle(propietarioId, nombre),
